...
По моей гипотезе у галаго Аллена есть пахучая анальная железа, которая анатомически близка к таковой у морской свинки, но, в отличие от последней, у галаго она есть у обоих полов. Галаго метит калом, к которому добавляется секрет анально-промежностной железы. 
